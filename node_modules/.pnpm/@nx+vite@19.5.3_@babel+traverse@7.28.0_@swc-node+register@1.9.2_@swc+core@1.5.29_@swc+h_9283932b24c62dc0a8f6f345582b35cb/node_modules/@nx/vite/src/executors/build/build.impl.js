...
async function* viteBuildExecutor(options, context) {
    ...
    if (!options.skipTypeCheck) {
        var _resolved_config_plugins;
        await (0, _executorutils.validateTypes)({
            workspaceRoot: context.root,
            tsconfig: tsConfigForBuild,
            isVueProject: Boolean((_resolved_config_plugins = resolved.config.plugins) == null ? void 0 : _resolved_config_plugins.find((plugin)=>typeof plugin === 'object' && (plugin == null ? void 0 : plugin.name) === 'vite:vue'))
        });
    }
